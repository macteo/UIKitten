...
class LayoutViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let _ = Button(title: "github").align([.top, .left]).margin(top: 70, left: 20).tap {
            print("Tapped GitHub")
        ...
        let _ = Button(title: "Cippa").margin(right: 20).type(.primary).align([.middle, .right]).add(to: view)
        // let _ = Button(icon: .arrowRight, title: "Next".uppercased(), position: .left)
